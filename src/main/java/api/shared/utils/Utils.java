...
public class Utils {
	...
	public static Player generateRandomPlayer(final String playerEmail) {
		...
		final Double averageTimeWrongMS = Double.valueOf(Math.random() * (60000 - 500) * (0.86 / 0.99));
		final Double averageTimeRightMS = Double.valueOf(Math.random() * (60000 - 500) * (0.86 / 0.99));
